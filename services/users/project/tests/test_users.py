...
class TestUserService(BaseTestCase):
    ...
    def test_add_user(self):
        ...
        with self.client:
            ...
            self.assertIn('michael@sonotreal.com was added!', data['message'])
            self.assertIn('success', data['status'])
    ...
    def test_add_user_duplciate_email(self):
    ...
    def test_single_user(self):
        """Ensure get single use behaves correctly"""
    ...
    def test_all_users(self):
        """Ensure get all ysers behaves correctly"""
        add_user('michael', 'michael@mherman.org', 'greaterthaneight')
        add_user('dalton', 'dmstegner@gmail.com', 'greaterthaneight')
        with self.client:
    ...
    def test_main_with_users(self):
        ...
        add_user('michael', 'michael@mherman.org', 'greaterthaneight')
        add_user('dalton', 'dalton@gmail.com', 'greaterthaneight')
        with self.client:
            response = self.client.get('/')
            self.assertEqual(response.status_code, 200)
            self.assertIn(b'All Users', response.data)
            ...
            self.assertIn(b'dalton', response.data)
