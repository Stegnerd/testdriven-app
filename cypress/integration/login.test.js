...
describe('Login', () => {
    ...
    it('should allow a user to sign in', () => {
        ...
        // different from example, default bootstrap behavior isn't to close navbar after clicking link
        // this actually closes instead of opening: https://stackoverflow.com/questions/21203111/bootstrap-3-collapsed-menu-doesnt-close-on-click
        //cy.get('.navbar-burger').click();
